...
subtitle: "5 easy steps to make your own data dashboard"
date: 2022-04-21
authors:
  - "AbdulMajedRaja RS"
...
![How to build a real-time live dashboard with Streamlit](https://streamlit.ghost.io/content/images/size/w2000/2022/11/real-time-live-dashboard.svg)
...
Can’t wait and want to jump right in? Here's [the code repo](https://github.com/amrrs/real-time-live-streamlit-dashboard-python?ref=streamlit.ghost.io) and [the video tutorial](https://youtu.be/OkodDZxsN1I?ref=streamlit.ghost.io).
...
![](https://streamlit.ghost.io/content/images/2022/04/Live-Data-Science-Dashboard-GIF-1.gif)
...
![table-1](https://streamlit.ghost.io/content/images/2022/04/table-1.png#browser)
...
3. Execute `streamlit run app.py` for the dashboard to start running on your [localhost](http://localhost/?ref=streamlit.ghost.io) and the link would be displayed in your Terminal and also opened as a new Tab in your default browser.
...
If you have any questions, please leave them below in the comments or reach out to me at [1littlecoder@gmail.com](mailto:1littlecoder@gmail.com) or on [Linkedin](https://www.linkedin.com/in/amrrs/?ref=streamlit.ghost.io).
